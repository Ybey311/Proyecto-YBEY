    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__auth">
                <?php if (empty($_SESSION['id_usuario'])) { ?>
                    <a href="<?php echo BASE_URL . 'principal/login'; ?>"><i class="fa fa-user"></i> Acceso</a>
                <?php } else {  ?>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="<?php echo BASE_URL . '/personalizar/index.php'; ?>">Personalizar</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <?php if (empty($_SESSION['id_usuario'])) { ?>
                                    <a href="<?php echo BASE_URL . 'principal/login'; ?>"><i class="fa fa-user"></i> Acesso</a>
                                <?php } else {  ?>
                                    <a href="<?php echo BASE_URL . 'profile'; ?>"><i class="fa fa-user"></i> Tu cuenta</a>
                                <?php } ?>
                            </div>
                    ...
                    <?php if ($data['title'] == 'Pagina Principal') { ?>
                        <div class="hero__item set-bg" data-setbg="<?php echo BASE_URL; ?>public/img/hero/banner.jpg">
                            <div class="hero__text">
                                <span>Tu estilo único, hecho realidad</span>
                                <h2>Personaliza tu mundo, <br />viste tu esencia</h2>
                                <p>Diseños únicos y exclusivos</p>
                                <a href="<?php echo BASE_URL . 'principal/productos'; ?>" class="p-2 mb-2 bg-light text-dark">Ver productos</a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
