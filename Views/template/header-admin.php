            ...
            <div class="content">
                ...
                <div class="topbar">
                    ...
                    <div class="topbar-left	d-none d-lg-block ">
                        <div class="text-center">
                            <a href="<?php echo BASE_URL; ?>" class="logo"><img src="<?php echo BASE_URL; ?>public/img/logo.png" height="65" width="65" alt="logo"></a>
                        </div>
                    </div>

                    <nav class="navbar-custom" style="background:#a573b0;">
                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list nav-user " >
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown" >
                                    ...
                                    <a class="dropdown-item" href="<?php echo BASE_URL . 'admin/salir'; ?>"><i class="fas fa-power-off"></i> Salir</a>
                                </div>
                            </li>
                        ...
                        <ul class="list-inline menu-left mb-0">
                            <li class="list-inline-item">
                                <button type="button" class="button-menu-mobile open-left waves-effect" style="background:#a573b0;">
