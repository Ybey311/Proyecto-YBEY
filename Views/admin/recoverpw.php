...
<head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="<?php echo BASE_URL; ?>public/css/toastify.min.css"
    />
...
<body class="fixed-left">
                            ...
                            <div class="p-2">
                                <form class="form-horizontal m-t-20" id="formulario" autocomplete="off">
                                    ...
                                    <div class="form-group text-center row m-t-20">
                                        <div class="col-12">
                                            <button class="btn btn-primary btn-block waves-effect waves-light" id="btnAccion" type="submit">Enviar</button>
                                        </div>
                                    </div>
    ...
    <script
      ...
      src="<?php echo BASE_URL; ?>public/js/toastify-js.js"
    ></script>
    <script src="<?php echo BASE_URL; ?>public/admin/js/page/recoverpw.js"></script>
