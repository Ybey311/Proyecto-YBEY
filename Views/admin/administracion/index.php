        ...
        <div class="card bg-primary mini-stat">
            <div class="p-3 mini-stat-desc">
                <div class="clearfix">
                    ...
                    <h4 class="mb-3 mt-0 float-right">$<?php echo number_format((!empty($data['pendientesAct']['total'])) ? $data['pendientesAct']['total'] : 0, 0); ?></h4>
                </div>
                <div>
            ...
            <div class="p-3">
                ...
                <p class="font-14 m-0">Anterior : $<?php echo number_format((!empty($data['pendientesAnt']['total'])) ? $data['pendientesAnt']['total'] : 0, 0); ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="card bg-info mini-stat">
            <div class="p-3 mini-stat-desc">
                <div class="clearfix">
                    ...
                    <h4 class="mb-3 mt-0 float-right">$<?php echo number_format((!empty($data['completadosAct']['total'])) ? $data['completadosAct']['total'] : 0, 0); ?></h4>
                </div>
                <div>
            ...
            <div class="p-3">
                ...
                <p class="font-14 m-0">Anterior : $<?php echo number_format((!empty($data['completadosAnt']['total'])) ? $data['completadosAnt']['total'] : 0, 0); ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="card bg-pink mini-stat">
            <div class="p-3 mini-stat-desc">
                <div class="clearfix">
                    ...
                    <h4 class="mb-3 mt-0 float-right">$<?php echo number_format($data['pendientesAct']['total'] + $data['completadosAct']['total'], 0); ?></h4>
                </div>
                <div>
            ...
            <div class="p-3">
                ...
                <p class="font-14 m-0">Anterior : $<?php echo number_format($data['pendientesAnt']['total'] + $data['pendientesAnt']['total'], 0); ?></p>
            </div>
        </div>
    </div>
</div>
